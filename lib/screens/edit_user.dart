...
class EditUser extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditUser> createState() => _EditUser();
}

class _EditUser extends ConsumerState<EditUser> {
...
Widget build(BuildContext context) {
  ...
  final usuario = ref.watch(selectedUserProvider);
                            ...
                            children: [
                              ...
                              Expanded(
                                child: DropdownButtonFormField<String>(
                                  ...
                                  initialValue: _type.text.isEmpty ? null : _type.text,
                                  validator: (value) => value == null || value.isEmpty ? context.lang.campo_obligatorio : null,
                                  ...
                                  items: [
                                    DropdownMenuItem<String>(
                                      value: 'client', // Valor interno
                                      child: Text(context.lang.cliente), // Texto que ve el usuario
                                    ),
                                    DropdownMenuItem<String>(
                                      value: 'admin',
                                      child: Text(context.lang.admin),
                                    ),
                                  ],

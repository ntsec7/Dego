...
class IndividualHistory extends ConsumerStatefulWidget {

  const IndividualHistory({super.key});

  @override
  ConsumerState<IndividualHistory> createState() => _IndividualHistory();
}

class _IndividualHistory extends ConsumerState<IndividualHistory> {
